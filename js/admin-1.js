...
var EDITOR_PAGINAS = [
  ...
  {archivo:'newsletter-club.html',                         nombre:'Newsletter · Bendito Club',         color:'#E8C24A', grupo:'Newsletter'},
  {archivo:'articulo-stand-boda.html',                     nombre:'Art. Stand en boda',                color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-elige-articulos.html',                nombre:'Art. Elige artículos',              color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-uniformes.html',                      nombre:'Art. Uniformes',                    color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-monouso.html',                        nombre:'Art. Monouso',                      color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-personalizacion-directo-empresa.html',nombre:'Art. Personalización en empresa',   color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-regalo-corporativo.html',              nombre:'Art. Regalo corporativo',           color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-packs-estacionales.html',              nombre:'Art. Packs estacionales',           color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-comision-evento.html',                 nombre:'Art. Comisión por evento',          color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-servicio-exclusivo.html',              nombre:'Art. Servicio exclusivo',           color:'#E8C24A', grupo:'Artículos'},
  {archivo:'articulo-cero-gestion.html',                    nombre:'Art. Cero gestión',                 color:'#E8C24A', grupo:'Artículos'},
];
